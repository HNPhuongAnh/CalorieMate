    ...
    private void loadUserData() {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(UserActivity.this, "Có lỗi xảy ra, vui lòng thử lại sau", Toast.LENGTH_SHORT).show();
            }
        });
    }
                ...
                .setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(UserActivity.this, "Đã lưu!", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(UserActivity.this, ResultsActivity.class);
                            ...
                            Toast.makeText(UserActivity.this, "Failed to save data!", Toast.LENGTH_SHORT).show();
